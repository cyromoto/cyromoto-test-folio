...
export class ProfileService {
  ...
  resumeurl = "https://drive.google.com/file/d/1J9AHt-dPxCbnAcBezBBK4s-3TVpZIdFU/view?usp=sharing"
  ...
  educationData: any = [
    {
      ...
      'info': `---------`,
      'institution': 'RAJAGIRI SCHOOL OF ENGINEERING AND TECHNOLOGY,INDIA'
    },
    {
      'id': '2',
      'from_to_year': '2022 - 2023(CURRENT)',
      'education': 'Masters',
      'stream': 'Computing( Data Analytics)',
  ...
  exprienceData: any = [
    {
      ...
      timeline: 'November 2019 - April 2022',
      role: 'Senior Systems Engineer',
      work: 'Working as a full stack developer .Responsible for handling the UI in Angular and Managing the api calls in java springboot.'
  ...
  extraCircularInfo: any = [
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/yakoobcyrus/'
    },
  ]
